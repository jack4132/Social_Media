...
@section('content')
<div class="container">
    <div class="row p-5" ><div class="col-3 pe-5 ps-5" style="padding-left:1rem">
	<img src="{{$user->profile->profileImage()}}" style="width:100%" class="rounded-circle"/></div>
	<div class="col-9">
	...
	@foreach($user->posts as $post)
		...
		<!-- <div class="col-4"><img src="/svg/post.jpeg" alt="" class="w-100"/></div>
		<div class="col-4"><img src="/svg/post.jpeg" alt="" class="w-100"/></div> -->
	</div></div>
</div>
</div>
